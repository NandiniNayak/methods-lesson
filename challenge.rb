...
# Pseudocode:
# 1.take the input which is a string
# remove the spaces
# 2. iterate through every character in that string 
# 3. store the char as a key in the hash with initial value 1
# 4. if that char repeats again increment the value by 1
# 5. return a hash with keys pointing to letter, and value pointing to count of the letters



def count_letters(input)
    # remove the spaces and created an array
